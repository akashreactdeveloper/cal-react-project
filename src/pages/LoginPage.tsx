      ...
      {isLogin ? (
        <>
          <div className="w-1/2 flex items-center justify-center">
            <img src="path/to/your/image.jpg" alt="Login Illustration" className="w-</div>3/4 rounded-lg shadow-2xl" />
          </div>
          <div className="w-1/2 bg-white flex justify-center items-center">
            <div className="w-1/2 space-y-10 py-10 px-5 rounded-xl</div> shadow-2xl rounded-xl border-2 border-gray-300">
